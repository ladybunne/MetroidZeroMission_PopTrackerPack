...
- [ ] I have tested using Universal Tracker if applicable (only for red or green squares, not yellow or blue) to verify that this is an issue specifically with the _tracker_, not the apworld.
- [ ] I have checked that my yaml options are not somehow the cause of this "bug".
- [ ] I have done my best to verify that this is a bug, and not a weird edge case I didn't know about. (For bonus points I may have asked in the thread or checked the logic rules in source.)

**Versions**
- [ ] I have ensured I am on [the latest version of the apworld](https://github.com/lilDavid/Archipelago-Metroid-Zero-Mission/releases/latest). I understand that issues pertaining to older apworld versions will be closed.
- [ ] I have tested using [the latest version of the pack](https://github.com/ladybunne/MetroidZeroMission_PopTrackerPack/releases/latest).
- [ ] I have tested using the latest version of PopTracker itself.
